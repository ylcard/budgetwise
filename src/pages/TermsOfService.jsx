        ...
        <div className="w-full py-4 md:py-6 pb-12">
            <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 px-3 md:px-4">
                <div className="text-center space-y-1.5 md:space-y-2 mb-4 md:mb-8">
                    <FileText className="w-8 h-8 md:w-12 md:h-12 mx-auto text-primary" />
                    <h1 className="text-2xl md:text-4xl font-bold text-foreground">Terms of Service</h1>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="border-l-4 border-destructive pl-4">
                                <h5 className="font-semibold text-foreground">4.1 Misuse the Service</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-destructive pl-4">
                                <h5 className="font-semibold text-foreground">4.2 Compromise Security</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-destructive pl-4">
                                <h5 className="font-semibold text-foreground">4.3 Violate Third-Party Rights</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-destructive pl-4">
                                <h5 className="font-semibold text-foreground">4.4 Commercial Misuse</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <h4 className="font-semibold text-foreground mt-6">5.2 Termination by Us</h4>
                        <p className="text-sm text-muted-foreground">
