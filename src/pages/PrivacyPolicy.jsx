        ...
        <div className="w-full py-4 md:py-6 pb-12">
            <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 px-3 md:px-4">
                ...
                <LegalCard>
                    ...
                    <LegalCardContent className="prose prose-sm max-w-none text-muted-foreground">
                        <p>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-foreground mb-2">2. Financial Information</h3>
                            <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                        ...
                        <div>
                            <h3 className="font-semibold text-foreground mb-2">3. Technical Information</h3>
                            <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="border-l-4 border-primary pl-4">
                                ...
                                <p className="text-sm text-muted-foreground">Used for authentication and optional map features. Subject to <a href="https://policies.google.com/privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google's Privacy Policy</a>.</p>
                            </div>

                            <div className="border-l-4 border-green-500 pl-4">
                                <h4 className="font-semibold text-foreground">TrueLayer</h4>
                                <p className="text-sm text-muted-foreground">Banking integration for automatic transaction sync. Subject to <a href="https://truelayer.com/privacy/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">TrueLayer's Privacy Policy</a>.</p>
                            </div>

                            <div className="border-l-4 border-purple-500 pl-4">
                                <h4 className="font-semibold text-foreground">eToro</h4>
                                <p className="text-sm text-muted-foreground">Investment portfolio tracking. Subject to <a href="https://www.etoro.com/customer-service/privacy-policy/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">eToro's Privacy Policy</a>.</p>
                            </div>

                            <div className="border-l-4 border-orange-500 pl-4">
                                <h4 className="font-semibold text-foreground">Frankfurter / ECB APIs</h4>
                                <p className="text-sm text-muted-foreground">Exchange rate data. Currency codes are transmitted for rate lookups. No personal financial data is sent.</p>
                            </div>

                            <div className="border-l-4 border-slate-500 pl-4">
                                <h4 className="font-semibold text-foreground">Gemini AI / Groq AI</h4>
