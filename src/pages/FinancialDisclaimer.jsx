        ...
        <div className="w-full py-6 pb-24">
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="text-center space-y-2 mb-8">
                    <AlertTriangle className="w-12 h-12 mx-auto text-amber-600 dark:text-amber-500" />
                    <h1 className="text-3xl md:text-4xl font-bold text-foreground">Financial Disclaimer</h1>
