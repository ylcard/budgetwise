        ...
        <div className="w-full py-4 md:py-6 pb-12">
            <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 px-3 md:px-4">
                <div className="text-center space-y-1.5 md:space-y-2 mb-4 md:mb-8">
                    <AlertTriangle className="w-8 h-8 md:w-12 md:h-12 mx-auto text-amber-600 dark:text-amber-500" />
                    <h1 className="text-2xl md:text-4xl font-bold text-foreground">Financial Disclaimer</h1>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="border-l-4 border-primary pl-4">
                                <h5 className="font-semibold text-foreground">Data Processing</h5>
                            ...
                            <div className="border-l-4 border-purple-500 pl-4">
                                <h5 className="font-semibold text-foreground">Third-Party Data</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-green-500 pl-4">
                                <h5 className="font-semibold text-foreground">Reports & Visualizations</h5>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
