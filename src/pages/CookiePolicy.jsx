        ...
        <div className="w-full py-4 md:py-6 pb-12">
            <div className="max-w-4xl mx-auto space-y-4 md:space-y-6 px-3 md:px-4">
                <div className="text-center space-y-1.5 md:space-y-2 mb-4 md:mb-8">
                    <Cookie className="w-8 h-8 md:w-12 md:h-12 mx-auto text-primary" />
                    <h1 className="text-2xl md:text-4xl font-bold text-foreground">Cookie & Storage Policy</h1>
                ...
                <LegalCard>
                    ...
                    <LegalCardContent className="space-y-4">
                        ...
                        <div>
                            <h4 className="font-semibold text-foreground mb-2">Local Storage</h4>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                            <h4 className="font-semibold text-foreground mb-2">Session Storage</h4>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <LegalCardContent className="space-y-4">
                        <div className="space-y-3">
                            <div className="border-l-4 border-green-500 pl-4">
                                ...
                                <p className="text-sm text-muted-foreground mb-2">Required for core app functionality. Cannot be disabled.</p>
                            ...
                            <div className="border-l-4 border-primary pl-4">
                                <h5 className="font-semibold text-foreground">Functional Storage</h5>
                                <p className="text-sm text-muted-foreground mb-2">Enhances functionality and remembers your preferences.</p>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-purple-500 pl-4">
                                <h5 className="font-semibold text-foreground">Performance Storage</h5>
                                <p className="text-sm text-muted-foreground mb-2">Improves app speed and reduces server requests.</p>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                            ...
                            <div className="border-l-4 border-orange-500 pl-4">
                                <h5 className="font-semibold text-foreground">Analytics Storage (Minimal)</h5>
                                <p className="text-sm text-muted-foreground mb-2">Basic usage tracking to improve the app.</p>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                    ...
                    <LegalCardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="bg-muted/50 border border-border rounded-lg p-4">
                                <h5 className="font-semibold text-foreground mb-1">Google Services</h5>
                                <p className="text-sm text-muted-foreground">
                                    If you use Google Sign-In or Google Maps features, Google may set cookies as described in <a href="https://policies.google.com/technologies/cookies" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google's Cookie Policy</a>.
                                </p>
                            </div>

                            <div className="bg-muted/50 border border-border rounded-lg p-4">
                                <h5 className="font-semibold text-foreground mb-1">TrueLayer (Banking)</h5>
                                <p className="text-sm text-muted-foreground">
                                    When connecting bank accounts, TrueLayer may use cookies for authentication and security. See <a href="https://truelayer.com/privacy/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">TrueLayer's Privacy Policy</a>.
                                </p>
                            </div>

                            <div className="bg-muted/50 border border-border rounded-lg p-4">
                                <h5 className="font-semibold text-foreground mb-1">eToro (Investments)</h5>
                                <p className="text-sm text-muted-foreground">
                                    If you connect eToro for portfolio tracking, eToro may set cookies. See <a href="https://www.etoro.com/customer-service/privacy-policy/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">eToro's Cookie Policy</a>.
                                </p>
                            </div>
                        </div>
                ...
                <LegalCard>
                    ...
                    <LegalCardContent className="space-y-4">
                        ...
                        <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                            <h5 className="font-semibold text-primary mb-2">Your Rights</h5>
                    ...
                    <LegalCardContent className="space-y-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mt-3">
                            <div className="bg-muted/50 border border-border rounded-lg p-3">
                                <h5 className="font-semibold text-foreground text-sm mb-1">Chrome</h5>
                                <p className="text-xs text-muted-foreground">Settings → Privacy and security → Clear browsing data</p>
                            </div>
                            <div className="bg-muted/50 border border-border rounded-lg p-3">
                                <h5 className="font-semibold text-foreground text-sm mb-1">Firefox</h5>
                                <p className="text-xs text-muted-foreground">Settings → Privacy & Security → Cookies and Site Data</p>
                            </div>
                            <div className="bg-muted/50 border border-border rounded-lg p-3">
                                <h5 className="font-semibold text-foreground text-sm mb-1">Safari</h5>
                                <p className="text-xs text-muted-foreground">Preferences → Privacy → Manage Website Data</p>
                            </div>
                            <div className="bg-muted/50 border border-border rounded-lg p-3">
                                <h5 className="font-semibold text-foreground text-sm mb-1">Edge</h5>
                                <p className="text-xs text-muted-foreground">Settings → Privacy, search, and services → Clear browsing data</p>
                            </div>
                        </div>
                    ...
                    <LegalCardContent className="space-y-4">
                        <div className="bg-green-50 border-2 border-green-500 rounded-lg p-4">
                            ...
                            <div className="bg-white/50 rounded p-3 mb-3">
                                <p className="text-sm text-foreground mb-2"><strong>When GPC is enabled, we:</strong></p>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                        ...
                        <div className="bg-blue-50 border-2 border-blue-500 rounded-lg p-4">
                            ...
                            <div className="bg-white/50 rounded p-3">
                                <p className="text-sm text-foreground mb-2"><strong>When DNT is enabled, we:</strong></p>
                                <ul className="list-disc pl-6 space-y-1 text-sm text-muted-foreground">
                        ...
                        <div className="bg-amber-50 border-2 border-amber-500 rounded-lg p-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-sm text-amber-700 dark:text-amber-300">
                                <li>
                        ...
                        <div className="bg-muted/50 border border-border rounded-lg p-4">
                            <h5 className="font-semibold text-foreground mb-2">How to Enable GPC or DNT</h5>
                            <div className="space-y-2 text-sm text-muted-foreground">
                                <div>
                                    <p className="font-medium">Global Privacy Control (GPC):</p>
                                    <ul className="list-disc pl-6 text-xs mt-1">
                                        <li><strong>Chrome/Edge:</strong> Install the <a href="https://globalprivacycontrol.org/" className="text-primary underline" target="_blank" rel="noopener noreferrer">GPC browser extension</a></li>
                        ...
                        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                            <h5 className="font-semibold text-green-700 dark:text-green-400 mb-2">✅ Verification & Transparency</h5>
