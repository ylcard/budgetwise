                                    ...
                                    {!isAbsoluteMode ? (
                                        ...
                                        <div className="pt-2 animate-in fade-in slide-in-from-top-2 duration-300 space-y-4">
                                                ...
                                                {Object.entries(FINANCIAL_PRIORITIES)
                                                    ...
                                                    .map(([key, config]) => (
                                                        <div key={key} className="space-y-1.5">
                                                            <Label className="text-xs justify-center font-semibold uppercase tracking-wider text-gray-500 flex items-center gap-2">
                                            ...
                                            <div className="flex justify-between items-center pt-2 border-t border-gray-100">
                                                <span className="text-sm justify-right font-medium text-gray-500">Total Allocated</span>
