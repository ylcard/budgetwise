...
export default function BankSync() {
  ...
  const [syncDateFrom, setSyncDateFrom] = useState(formatDateString(subDays(new Date(), 30)));
  ...
  useEffect(() => {
    ...
    handleCallback();
  }, [queryClient, toast, user, executeSync]);
    ...
    <div className="container max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          ...
          <button
            onClick={() => setSyncDateFrom(formatDateString(subDays(new Date(), 2192)))}
