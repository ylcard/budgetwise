...
export default function Dashboard() {
    ...
    const realMonthTransactions = useMemo(() => {
        ...
        const bufferStart = formatDateString(subDays(realStart, 30));
        // JS Date handles month overflow automatically in getFirstDayOfMonth
        const realEnd = getFirstDayOfMonth(now.getMonth() + 1, now.getFullYear());
