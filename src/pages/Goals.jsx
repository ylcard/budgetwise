...
export default function GoalsPage() {
  ...
  // Global FAB Configuration
  const goalsFab = useMemo(() => {
  ...
  }, [activeView, setCreateDrawerOpen]);

  useEffect(() => {
    setFabButtons(goalsFab);
