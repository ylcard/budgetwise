...
const ReportStats = memo(function ReportStats({
  ...
  return (
    <div className="flex md:grid md:grid-cols-3 gap-4 w-full min-w-0 overflow-x-auto snap-x snap-mandatory pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 md:overflow-visible [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
      <Card className="border-none shadow-lg shrink-0 w-[85vw] md:w-auto snap-center">
