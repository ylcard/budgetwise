...
function TransactionMonthGroup({ date, categories, customBudgets, onEdit, onDelete, settings, isFirst }) {
  ...
  return (
    <div className="-mt-px first:mt-0">
      <div className="sticky top-0 z-10 bg-card px-4 py-2 text-xs font-semibold text-center text-muted-foreground uppercase tracking-wider border-b border-border/50">
