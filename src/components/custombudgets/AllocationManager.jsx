...
export default function AllocationManager({
  ...
  const totalAllocated = allocations
    .reduce((sum, a) => sum.plus(a.allocatedAmount), new Decimal(0))
    .toNumber();
  const remainingFunds = new Decimal(customBudget.allocatedAmount).minus(totalAllocated).toDecimalPlaces(2).toNumber();
