...
export default function ExpenseFormDialog({
  ...
  transactionTemplate = null, // For pre-filling a new transaction (e.g. from recurring)
  categories,
  ...
  const isEditMode = !!transaction && !!transaction.id; // Only edit if ID exists
  ...
  const defaultTrigger = isEditMode ? (
    <CustomButton variant="ghost" size="icon" className="hover:bg-primary/10 hover:text-primary h-7 w-7">
