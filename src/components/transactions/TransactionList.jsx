            ...
            {selectedIds.size > 0 && (
              ...
              >
                ...
                <CustomButton
                  variant="secondary"
                  size="sm"
                  onClick={onEditSelected} // New Prop
                  className="h-7 text-xs px-2 md:px-3 hover:bg-accent"
                >
        ...
        <table className="w-full text-sm text-left border-collapse min-w-[1000px]">
          <thead className="text-xs text-muted-foreground uppercase bg-muted/50 border-b border-border">
            <tr>
              ...
              <th className="px-4 py-4 w-1/4 text-center whitespace-nowrap">Note</th>
              <th className="pl-4 pr-10 py-4 w-28 text-center">Actions</th>
            </tr>
          </thead>
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-2 text-right">
                    <span className={`font-mono font-medium ${isIncome ? 'text-[hsl(var(--stat-income-text))]' : 'text-foreground'}`}>
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  ...
                  <div className="shrink-0">
                    {isIncome ? (
                      <div className="w-9 h-9 rounded-full flex items-center justify-center bg-[hsl(var(--status-paid-bg))]">
                        <Banknote className="w-4 h-4 text-[hsl(var(--status-paid-text))]" />
                      </div>
                    ) : (
                      <div
                  ...
                  <div className="flex flex-1 items-center justify-between min-w-0 gap-3">
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <div className="flex justify-end mb-1" onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <button className="p-1 -mr-2 text-muted-foreground hover:text-foreground">
                      ...
                      <span className={`text-sm font-mono font-bold ${isIncome ? 'text-[hsl(var(--stat-income-text))]' : 'text-foreground'}`}>
                        {isIncome ? '+' : '-'}{formatCurrency(transaction.amount, settings)}
                      </span>
                    </div>
                  </div>
