...
// CREATED 16-Jan-2025: Generic entity update hook
// This hook centralizes the common pattern for updating entities:
// 1. Optional preprocessing via onBeforeUpdate (receives { id, data, oldEntity })
// 2. API call to base44.entities[entityName].update(id, processedData)
...
// - Supports complex side effects (e.g., cash wallet adjustments, status-dependent logic)
// - Simplifies maintenance (single source of truth for update logic)