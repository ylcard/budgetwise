...
export default function EtoroTicker() {
    ...
    // Formatting: 10300 -> $10.3k (Respects Settings)
    const formatValue = (val) => {
        // Map separator preference to approximate locale for compact numbers
        const locale = settings?.decimalSeparator === ',' ? 'de-DE' : 'en-US';
