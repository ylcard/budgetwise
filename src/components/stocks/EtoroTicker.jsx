...
export default function EtoroTicker() {
  ...
  return (
    <div className="w-full bg-slate-900 text-white py-2.5 flex items-center shadow-md border-b border-slate-800">
      ...
      {/* Scrolling Content */}
      <div className="flex items-center gap-8 px-4 overflow-x-auto no-scrollbar whitespace-nowrap scroll-smooth animate-in fade-in slide-in-from-right-4 duration-1000">
        {status === "Syncing..." && (
        ...
        {positions.map((pos) => (
          <div key={pos.instrumentId} className="flex items-center gap-2 text-sm">
