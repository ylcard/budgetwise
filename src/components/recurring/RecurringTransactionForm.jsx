    ...
    <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 overflow-hidden">
      <div className="flex-1 overflow-y-auto px-4 pb-4 pt-4 md:px-0 md:overflow-visible">
        ...
        <div className="flex justify-center pb-2 mb-6">
          <div className="flex gap-2 p-1 bg-muted/80 rounded-lg border border-border/50">
            <CustomButton
              type="button"
        ...
        <div className="flex items-center space-x-2 bg-muted/30 p-3 rounded-lg border border-border">
          ...
          />
          <Label htmlFor="isActive" className="cursor-pointer font-medium text-foreground">
            Active
          </Label>
        </div>
      </div>
