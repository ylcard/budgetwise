...
import { Drawer, DrawerContent, DrawerHeader, DrawerTitle, DrawerTrigger, DrawerFooter, DrawerClose } from "@/components/ui/drawer"; // shadcn uses Vaul internally
import { Progress } from "@/components/ui/progress";
import { motion } from "framer-motion";
import { Trophy, Flame, Lock, Star, Zap } from 'lucide-react';
import { CustomButton } from "@/components/ui/CustomButton";

export const UserAvatar = ({ size = "sm" }) => { // size: sm (header) | lg (drawer)
    const { user } = useAuth();
            ...
            <DrawerContent>
                <div className="mx-auto w-full max-w-sm">
                    <DrawerHeader className="flex flex-col items-center pt-8 pb-4">
                        ...
                        <DrawerTitle className="text-2xl font-bold">{user?.name}</DrawerTitle>
                        <p className="text-muted-foreground text-sm">Novice Saver</p>
                    </DrawerHeader>

                    <div className="px-6 pb-8 space-y-6">
                        {/* Main Stats Grid */}
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-muted/50 rounded-xl p-4 flex flex-col items-center justify-center text-center gap-2 border border-border/50">
                        ...
                        {/* Unlocks Teaser (Visual only for now) */}
