...
// Utility component for smooth height animations (dependency-free)
const Collapse = ({ children, open, className = "" }) => (
    <div className={cn("grid transition-all duration-300 ease-in-out", open ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0", className)}>
                ...
                <div className="p-4 overflow-y-auto flex-1 pb-[calc(2rem+env(safe-area-inset-bottom))]">
                    ...
                    {formData.type === 'expense' && (
                        <div className="space-y-6">
                            ...
                            {!formData.isPaid && (
                                <div className="text-center text-sm text-gray-500 py-2">Editing Transaction Date</div>
                            )}
                        </div>
                    )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
            ...
            <div className="flex items-start gap-3">
                <div className="flex-1">
                    ...
                    />
                    <Collapse open={isForeignCurrency}>
