    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed inset-x-0 mx-auto z-5000 w-10 h-10 rounded-full bg-white/40 dark:bg-card/40 backdrop-blur-md border border-border/40 shadow-sm flex items-center justify-center text-muted-foreground hover:text-foreground active:scale-95 transition-all"
