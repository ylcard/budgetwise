        ...
        <CommandEmpty className="py-2 px-4 text-sm">
          ...
          {canCreate && searchTerm.trim().length > 0 ? (
            <button
              ...
              disabled={isCreating}
              className="flex items-center gap-2 w-full text-left p-2 rounded-md hover:bg-accent text-primary transition-colors"
            >
                ...
                return (
                  ...
                  >
                    ...
                    {category.isSystemCategory && (
                      <span className="ml-auto text-[10px] bg-muted text-muted-foreground px-1.5 py-0.5 rounded">System</span>
                    )}
                  </CommandItem>
                );
              })}
