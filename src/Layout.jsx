              ...
              {secondaryNav.length > 0 && (
                <Sheet open={isMoreMenuOpen} onOpenChange={setIsMoreMenuOpen}>
                  <SheetTrigger asChild>
                    <button className="flex flex-1 flex-col items-center justify-center gap-1 py-1.5 text-muted-foreground min-w-0">
                  ...
                  <SheetContent side="bottom" className="rounded-t-[20px] px-0 pb-10">
                    ...
                    <div className="grid grid-cols-1 divide-y divide-border">
                      ...
                      <button
                        onClick={() => logout()}
                        className="flex items-center gap-4 px-6 py-4 text-destructive hover:bg-destructive/10 transition-colors"
                      >
